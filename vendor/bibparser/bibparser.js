...
function getRawTex(j) {
    if (typeof j.entries[0] == 'undefined') {
        return "";
    }
    g = j.entries[0];
    var code = "@" + g.EntryType + "{" + g.EntryKey + ",\n";
    angular.forEach(j.entries[0].Fields, function(value, key) {
        code += "  " + key + "={" + value + "},\n";
    });
    code += "}";
    return code;
